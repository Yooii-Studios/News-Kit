 ...
 */
public class StoreDebugChecker {
     ...
     * Singleton
     */
    private volatile static StoreDebugChecker instance;
    private StoreDebugChecker() {}
    public static StoreDebugChecker getInstance(Context context) {
        if (instance == null) {
            synchronized (StoreDebugChecker.class) {
                if (instance == null) {
                    instance = new StoreDebugChecker();

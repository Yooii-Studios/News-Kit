...
# Json에서 사용되는 proguard 파일
# http://stackoverflow.com/questions/6533676/proguard-and-gson-on-android-classcastexception
...
# http://webcache.googleusercontent.com/search?q=cache:9UxNGhWOpukJ:stackoverflow.com/questions/14111150/application-stopped-working-after-enabling-proguard+&cd=1&hl=ko&ct=clnk&gl=kr&client=safari
...
# 필요없는듯
#-libraryjars libs/Digital_Garage_OneSDK_20140528.jar
#-libraryjars libs/FlurryAnalytics-4.0.0.jar
#-libraryjars libs/naver-iap-sdk-1.4.jar

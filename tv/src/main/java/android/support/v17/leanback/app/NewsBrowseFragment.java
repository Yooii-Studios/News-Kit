...
/**
 * Created by Wooseong Kim in TvTest from Yooii Studios Co., LTD. on 15. 3. 5.
 * NewsBrowseFragment
 * Description
 */
public class NewsBrowseFragment extends Fragment {
     ...
     * {@link android.support.v17.leanback.widget.Row}. These rows will be used by the rows fragment and the headers
     * fragment (if not disabled) to render the browse rows.
     *
     * @param adapter An ObjectAdapter for the browse rows. All items must
     *        derive from {@link android.support.v17.leanback.widget.Row}.
     */
     ...
     * @deprecated Use {@link #setOnItemViewSelectedListener(android.support.v17.leanback.widget.OnItemViewSelectedListener)}
     */
     ...
     *
     * <p>OnItemClickedListener will override {@link android.view.View.OnClickListener} that
     * an item presenter may set during
     * {@link android.support.v17.leanback.widget.Presenter#onCreateViewHolder(android.view.ViewGroup)}. So in general, you
     * should choose to use an {@link android.support.v17.leanback.widget.OnItemClickedListener} or a
     * {@link android.view.View.OnClickListener} on your item views, but not both.
     *
     * @param listener The listener to call when an item is clicked.
     * @deprecated Use {@link #setOnItemViewClickedListener(android.support.v17.leanback.widget.OnItemViewClickedListener)}
     */
    ...
    /**
     * Sets an item clicked listener on the fragment.
     * OnItemViewClickedListener will override {@link android.view.View.OnClickListener} that
     * item presenter sets during {@link android.support.v17.leanback.widget.Presenter#onCreateViewHolder(android.view.ViewGroup)}.
     ...
     *
     * <p>The listener's {@link android.view.View.OnClickListener#onClick onClick} method
    ...
    /**
     * Returns the {@link android.support.v17.leanback.widget.SearchOrbView.Colors} used to draw the search affordance.
     */
    ...
    private void startHeadersTransitionInternal(final boolean withHeaders) {
        ...
        // FIXME: 주석
        // header 가 사라질 때는 mShowingHeaders 가 false, 나타날 때는 true
        mRowsFragment.onExpandTransitionStart(!withHeaders, new Runnable() {
            ...
            public void run() {
                ...
                // FIXME: 주석
                // header 가 보이는 액션(왼쪽의 경우 mSceneWithHeaders 가 mHeaderTransition 과 같이 실행됨
                // header 가 가려질 경우 mSceneWithHeaders 가 mHeaderTransition 과 같이 실행
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mContainerListMarginLeft = (int) ta.getDimension(
                android.support.v17.leanback.R.styleable.LeanbackTheme_browseRowsMarginStart, 0);
        mContainerListAlignTop = (int) ta.getDimension(
                android.support.v17.leanback.R.styleable.LeanbackTheme_browseRowsMarginTop, 0);
        ta.recycle();

        mHeadersTransitionStartDelay = getResources()
                .getInteger(android.support.v17.leanback.R.integer.lb_browse_headers_transition_delay);
        mHeadersTransitionDuration = getResources()
                .getInteger(android.support.v17.leanback.R.integer.lb_browse_headers_transition_duration);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mTitleView = (TitleView) root.findViewById(android.support.v17.leanback.R.id.browse_title_group);
        ...
        sTransitionHelper.excludeChildren(mTitleUpTransition, android.support.v17.leanback.R.id.browse_headers, true);
        sTransitionHelper.excludeChildren(mTitleDownTransition, android.support.v17.leanback.R.id.browse_headers, true);
        sTransitionHelper.excludeChildren(mTitleUpTransition, android.support.v17.leanback.R.id.container_list, true);
        sTransitionHelper.excludeChildren(mTitleDownTransition, android.support.v17.leanback.R.id.container_list, true);
    ...
    // FIXME: 인터폴레이터, 시간, 애니메이션 등등 확인 필요
    private void createHeadersTransition() {
        mHeadersTransition = sTransitionHelper.createTransitionSet(false);
        sTransitionHelper.excludeChildren(mHeadersTransition, android.support.v17.leanback.R.id.browse_title_group, true);
...
//            sTransitionHelper.createDefaultInterpolator(context)
            sTransitionHelper.setInterpolator(changeBounds, fastOutSlowInInterpolator);
...
//        sTransitionHelper.addTransition(mHeadersTransition, fadeIn);
    ...
    /**
     * Sets the {@link android.support.v17.leanback.widget.PresenterSelector} used to render the row headers.
     *
...
//        mHeadersFragment.setHeadersEnabled(show);
        ...
        // FIXME: 이 로직이 row 들을 팽창하게 만들기에 주석처리하면 아예 늘어나 있음
